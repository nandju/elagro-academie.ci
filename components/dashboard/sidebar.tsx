...
const navItems: NavItem[] = [
  ...
  { title: "Mes Cours", href: "/courses", icon: BookOpen },
  { title: "Cours Sauvegardés", href: "/dashboard/saved", icon: Bookmark },
  { title: "Rapports", href: "/dashboard/reports", icon: BarChart3 },
  { title: "Explorer", href: "/courses", icon: GraduationCap },
  { title: "Certificats", href: "/certificates", icon: Award },
  { title: "Transactions", href: "/dashboard/transactions", icon: Receipt },
  { title: "Centre d'aide", href: "/dashboard/help", icon: HelpCircle },
  { title: "Paramètres", href: "/profile", icon: Settings },
]
        ...
        <div className="p-4 border-b border-sidebar-border">
          <div className="flex items-center justify-between">
            {(!isCollapsed || isMobile) && (
              <Link href="/dashboard" className="flex justify-center items-center" onClick={handleLinkClick}>
